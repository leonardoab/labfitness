...
CREATE TABLE aluno (
  ...
  dsc_cpf VARCHAR(14) NULL,
  dsc_email VARCHAR(255) NULL,
  id_estado INTEGER NULL,
  id_estado_civil INTEGER NOT NULL,
  flg_sexo BOOL NULL,
  dsc_cep VARCHAR(9) NULL,
  id_cidade INTEGER NULL,
  id_bairro INTEGER NULL,
  id_endereco INTEGER NULL,
  num_numero INTEGER NULL,
  dsc_complemento VARCHAR(255) NULL,
  PRIMARY KEY(id_aluno),
  INDEX aluno_FKIndex1(id_estado),
  INDEX aluno_FKIndex2(id_cidade),
  INDEX aluno_FKIndex3(id_bairro),
  INDEX aluno_FKIndex4(id_endereco),
  INDEX aluno_FKIndex5(id_estado_civil),
  FOREIGN KEY(id_estado)
    REFERENCES estado(id_estado)
      ON DELETE NO ACTION
      ON UPDATE NO ACTION,
